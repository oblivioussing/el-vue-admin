(() => {
	...
	//接口状态map
	window.STATE_MAP = {
		10: { responseMsg: '操作成功!', Msg: '成功!' },
		11: { responseMsg: '权限认证失败!', Msg: '登陆失效，请重新登录!' },
		12: { responseMsg: '未登录，请重新登录!', Msg: '未登录，请重新登录!' },
		13: { responseMsg: '登陆超时，请重新登录!', Msg: '登陆超时，请重新登录!' },
		14: { responseMsg: '失败登录次数过多，用户被锁定!', Msg: '登录失败次数过多，您的账户被锁定!' },
		15: { responseMsg: '登录名不能为空!', Msg: '登录名不能为空!' },
		16: { responseMsg: '令牌密钥不能为空!', Msg: '登陆失效，请重新登录!' },
		16: { responseMsg: '表单验证失败!', Msg: 'Form valid error!' },
	}
